...
<?php echo do_shortcode('[ajax_load_more post_type="blog_post" taxonomy="blog_tags:press_tags" taxonomy_terms="" taxonomy_operator="IN:IN"  posts_per_page="9" scroll="false" transition_container="false" button_label="Load More"]'); ?>
